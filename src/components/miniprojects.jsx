...
const projects = [
  {
    ...
    description:
      "An App to predict stock prices using Machine learning",
  },
  {
    title: "Auto-Trading-Bot",
    description:
      "A Python-based automated trading bot that interacts with Zerodha’s Kite Connect API to fetch live market data, execute trades, and manage positions.",
  },
  {
    title: "Sudoku Solver",
    description:
      "A Python-based backtracking algorithm that automatically solves standard 9x9 Sudoku puzzles, showcasing algorithmic problem-solving and recursive logic implementation.",
...
const MiniProjectsDone = () => {
  ...
  return (
    ...
    <div className="relative flex flex-col items-center justify-center w-full py-20 px-4 bg-black">
      ...
      {/* Project Cards */}
      <div className="relative z-10 flex flex-wrap justify-center gap-8 gap-y-1">
...
export default MiniProjectsDone;